...
public class JavaBasedStdPlaywayObjectFactory implements StdPlaywayObjectFactory {

  private static final Logger LOGGER =
    LoggerFactory.getLogger(JavaBasedStdPlaywayObjectFactory.class);
  ...
  public JavaBasedStdPlaywayObjectFactory(final ClassLoader parent) {
  ...
  private class JavacCodeCompiler implements CodeCompiler {
    ...
    public void compile(final CodeParsedResult codeParsedResult) {
      ...
      JavaBasedStdPlaywayObjectFactory.this.playwayClassLoader.setClassfileBytesCache(classfileBytesCache);
    }
  }
